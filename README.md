...
| Platform | Status |
| --- | --- |
| macOS 26+ (Apple silicon / Intel) | built, tested, and manually verified — including on macOS 27 (Xcode 27 SDK) |
...
- `git` on your `PATH`
- macOS 26 or newer: Xcode command line tools (`xcode-select --install`) for the Metal backend
